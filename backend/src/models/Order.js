...
const lineItemSchema = new mongoose.Schema({
  ...
  width_tol_dir: { type: String, enum: ['both', 'plus', 'minus'], default: 'both' },
  length_tol_dir: { type: String, enum: ['both', 'plus', 'minus'], default: 'both' },
  gauge_tol_dir: { type: String, enum: ['both', 'plus', 'minus'], default: 'minus' },
